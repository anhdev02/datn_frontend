...
const HeaderStoresRes = () => {
  return (
    <header id="header">
        <div className="header sub-header">
          <h1 className="sub-h1">
            <span className="headcategory-span">Hệ thống cửa hàng</span>
          </h1>
          ...
          <section id="topArea">
            <nav id="mainMenu">
              <div id="mainMenuIn" className="xans-element- xans-product xans-product-menupackage swiper-container swiper-container0">
                <ul className="swiper-wrapper">
                  <li className="swiper-slide my_li0 ">
                    <a className="my_a" href="/policys.html">Chăm sóc khách hàng</a>
                  </li>
                  <li className="swiper-slide my_li1 actdisplaynone">
                    <a className="my_a" href="/stores.html">Hệ thống cửa hàng</a>
                  </li>
                </ul>
              </div>
